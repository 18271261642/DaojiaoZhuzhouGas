 ...
 * 气瓶所属单位列表适配器
 */
public class BotBelongListAdapter extends BaseAdapter {
    ...
    public BotBelongListAdapter(List<Map> mapList, Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textView.setText(""+mapList.get(position).get("air_bottle_belong_name"));
        return convertView;
    }
